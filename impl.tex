...
%The sampler runs seasonally to update the metrics related to the current running tasks, Spark memory manger and JVM heap manager. 
%Each executor launches one scheduler and one sampler in Spark.
